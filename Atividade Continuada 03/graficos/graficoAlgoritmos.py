...
arquivo_cocktail = os.path.join(diretorio_script, "../resultados/resultadoCocktail.txt")
...
# arquivo_saida = os.path.join(diretorio_script, "comparativoBubbleCocktail.png")
...
t_cocktail, tempo_cocktail = ler_dados(arquivo_cocktail)
