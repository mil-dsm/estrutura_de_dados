...
ErrorType point_sum(Point *p1, Point *p2, Point *out_point) {
    if(p1 == NULL || p2 == NULL || out_point == NULL) {
        return ERROR_NULL_POINTER;
    }
    out_point->x = p1->x + p2->x;
    out_point->y = p1->y + p1->y;
    return ERROR_OK;
}

ErrorType point_sub(Point *p1, Point *p2, Point *out_point) {
    if(p1 == NULL || p2 == NULL || out_point == NULL) {
        return ERROR_NULL_POINTER;
    }
    out_point->x = p1->x - p2->x;
